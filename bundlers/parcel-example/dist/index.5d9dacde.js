...
},{"./main.js":"bDbGG","../styles/main.scss":"2c1jJ"}],"bDbGG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _printResultJs = require("./printResult.js");
...
form.onsubmit = (event)=>{
    ...
    if (!firstDate || !secondDate) (0, _printResultJs.printError)("Ooopps - \u0432\u0432\u0435\u0434\u0438\u0442\u0435 \u0434\u0430\u0442\u0443");
    else {
        const dateDiff = (0, _getDateDiffJsDefault.default)(firstDate, secondDate);
        (0, _printResultJs.printResult)(dateDiff);
    }
};

},{"./printResult.js":"asdSc","./getDateDiff.js":"1bxDH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"asdSc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function getDateDiff(dateFrom, dateTo) {
    ...
    const dateFromObject = (0, _luxon.DateTime).fromISO(dateFrom);
    const dateToObject = (0, _luxon.DateTime).fromISO(dateTo);
    return dateFromObject.diff(dateToObject, [
        "years",
        "months",
        "days"
    ]).toObject();
...
},{}],"2c1jJ":[function() {},{}]},["gzp3I","1Z4Rq"], "1Z4Rq", "parcelRequire94c2")
